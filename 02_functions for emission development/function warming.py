...
# Data from projections of the German Federal Environmental Agency (2024) for the share of non-renewable heating energy from 2025 to 2045
...
values = np.array([
    71.9, 69.9, 68.0, 66.1, 62.2, 58.8, 55.5, 52.0, 48.0,
    44.4, 39.9, 36.5, 33.3, 30.2, 27.0, 23.3, 21.1, 18.7, 16.7,
    14.8, 11.6
])
...
for i, (func, name, x, p0) in enumerate(functions):
    try:
        ...
        plt.plot(years, y_pred, label=f"{name} (R²={r2:.5f})", color=color_cycle[i % len(color_cycle)], linewidth=2)
...
plt.ylabel("Share of non-renewable heating energy [%]", fontsize=16)
